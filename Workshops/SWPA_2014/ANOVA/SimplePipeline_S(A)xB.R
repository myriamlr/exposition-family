...
part.repeat.wide.format <- read.csv("http://exposition-family.googlecode.com/svn/Workshops/SWPA_2014/ANOVA/S(A)xB.csv")
...
dev.new()
interaction.plot(part.repeat.long.format$A,part.repeat.long.format$B,part.repeat.long.format$y,type="b",xlab="Age Group (Between)",ylab="SOMETHING",trace.label="Similarity (Repeated)",pch=c(20,22),cex=2,lwd=2,col=c("mediumorchid4","darkseagreen"))
